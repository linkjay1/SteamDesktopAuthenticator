...
- Open Terminal to the folder that contains the EXE and run `mono 'Steam Desktop Authenticator.exe`. This will open the EXE as if it were on Windows through Mono. Since the app is pretty lightweight, this feature should work and you should have all features available to you including the ability to import an old maFiles. 
